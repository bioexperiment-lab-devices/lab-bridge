...
HOME_STRINGS: dict[Lang, dict[str, str]] = {
    "en": {
        ...
        "labs_hidden_eyebrow": "Sign-in required",
        "labs_hidden_title": "Sign in to view live lab status",
        "labs_hidden_body": "The labs roster is only visible to authenticated users. Credentials are issued by the server administrator.",
        "labs_hidden_cta": "Sign in",
        "labs_hidden_admin": "No account? Ask your server administrator.",
        "labs_hidden_docs": "Read the public docs →",
    ...
    "ru": {
        ...
        "labs_hidden_eyebrow": "Требуется вход",
        "labs_hidden_title": "Войдите, чтобы увидеть состояние лабораторий",
        "labs_hidden_body": "Список лабораторий виден только аутентифицированным пользователям. Учётные данные выдаёт администратор сервера.",
        "labs_hidden_cta": "Войти",
        "labs_hidden_admin": "Нет учётной записи? Обратитесь к администратору сервера.",
        "labs_hidden_docs": "Открытая документация →",
