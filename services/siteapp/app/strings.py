...
HOME_STRINGS: dict[Lang, dict[str, str]] = {
    "en": {
        ...
        "labs_hidden_title": "Sign in to view lab status",
        "labs_hidden_body": "Live lab availability and SerialHop versions are visible to signed-in users only.",
    ...
    "ru": {
        ...
        "labs_hidden_title": "Войдите, чтобы видеть состояние лабораторий",
        "labs_hidden_body": "Текущая доступность лабораторий и версии SerialHop видны только авторизованным пользователям.",
